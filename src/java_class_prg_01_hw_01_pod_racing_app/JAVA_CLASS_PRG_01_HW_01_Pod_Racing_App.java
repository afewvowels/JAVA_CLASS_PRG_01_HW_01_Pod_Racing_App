...
public class JAVA_CLASS_PRG_01_HW_01_Pod_Racing_App extends JFrame implements ActionListener {
    ...
    public void drawBoard() {
        ...
        for (int p = 0; p < podCount; p++) {
            ...
            // This counter keeps track of the total number of pods that have
            // been caught to determine if game is over
            else if (pods[p].isCaught()) {
                counter++;
            }
        }
        
        // If the above counter reaches 4 then a message fires announcing a win
